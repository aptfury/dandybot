...
const { ContextMenuCommandBuilder, ApplicationCommandType, EmbedBuilder, MessageFlags, Embed } = require('discord.js');
const { customQuoteModal } = require('../../modals/addUserQuote.js');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        .then(interaction => {
            ...
            interaction.reply({
                content: "Sent to the quote channel!",
                flags: MessageFlags.Ephemeral
            });
        })
